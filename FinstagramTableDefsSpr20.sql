DROP DATABASE IF EXISTS Finstagram;
CREATE DATABASE Finstagram;
USE Finstagram;
...
CREATE TABLE Photo (
        ...
        filePathphoto VARCHAR(255), -- you may replace this by a BLOB attribute to store the actual photo
        allFollowers INT,
